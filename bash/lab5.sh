...
function error-exit {
  echo "!!! Error: EXITING. Exit Statys: $*"
  exit
}
# Usage:
...
OPTION:
  -h or --help
        provide this help and exist
  --host
        only provide host name
  --domain
        only provide NIS/YP domain name
  --ipconfig
        only provide this machine's IP info and all network interfaces
  --os
        only provide this machine's OS name and version
  --cpu
        only provide this machine's hardware information
  --memory
        only provide this machine's memories information
  --disk
        only provide this machine's disk usage information
  --printer
        only provide this machine's printer information

any other option gives an error
"
}
